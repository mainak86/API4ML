...
from app.schemas import ChatSessionRead, MessageCreate, MessageRead, MarkdownFormat
from app.services import get_ai_response, validate_all_guardrails
from app.utils.markdown import MarkdownResponseFormatter
import asyncio
...
def format_message_with_markdown(message: Message) -> dict:
    """Helper function to format a message with markdown detection"""
    markdown_data = MarkdownResponseFormatter.format_response(
    ...
    return {
        ...
        "format": {
            "is_markdown": markdown_data["format"]["is_markdown"],
            "confidence": markdown_data["format"]["confidence"],
            "has_code": markdown_data["format"]["has_code"],
            "has_links": markdown_data["format"]["has_links"],
            "has_lists": markdown_data["format"]["has_lists"],
            "sections": markdown_data["format"]["sections"],
        },
        "display_as_markdown": markdown_data["display_as_markdown"],
    }
